...
public class MainMenu {
    ...
    public MainMenu(Stage primaryStage) {
        /**
         * This sets up the main menu and intro to the game
         */
        ...
        Text description = new Text("You’re the new guy working in Seven Guys, a local burger shop that" +
                "on the outside, is a fun and exciting place to eat at, " +
                "\nfilled with yummy food and a huge-ass party stage with cool party rooms, and of course, " +
                "the main attraction: " +
                "High Fives. But behind closed doors, a different story appears.\n" +
                ...
                "\n“Is this a tutorial?” (Pick the options presented to make your choice, choose wisely, " +
                "well in this case you only have one but, you know, don’t fall too deep~)\n");
