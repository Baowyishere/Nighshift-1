...
public class OneAM {
    /**
     * This sets up the entire oneAM sequence including 1 death and 2 possible outcomes based on stats
     */
    private Scene scene;
    ...
    public OneAM(Stage primaryStage) {
        ...
        judgementButton.setOnAction(e -> {
            ...
            else {gameStatus.setText("Luckily, you avoided some of the dangers. You lucked out." +
